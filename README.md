### I had to get some date fields as strings because the program was sending "0" to some date fields and I was getting an error because the field could not be parsed. 
